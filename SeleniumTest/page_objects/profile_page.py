...
class ProfilePage:
    ...
    def open_from_home(self):
        self._driver.find_element(By.CLASS_NAME, "dropdown-toggle").click()
        self._driver.find_element(By.XPATH, "//a[contains(.,'Profile')]").click()

    def check_user_name(self, name, last_name):
        name_element = self._driver.find_element(By.CLASS_NAME, "profile_name")
        # assert name_element.text == f"{name} undefined"
